...
<rule xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <assert role="error"
           test="not(descendant-or-self::*[@nullFlavor and (@value|@unit|hl7:low|hl7:center|hl7:high|hl7:width)])">dtr1-2-IVL_TS: null violation. Cannot have @nullFlavor and @value or other child elements</assert>
    ...
    <assert role="error" test="@nullFlavor or descendant-or-self::*[@value]"
        ...
        -->
    <assert role="error"
           test="not(@value and (hl7:low|hl7:center|hl7:high|hl7:width))">dtr1-4-2-IVL_TS: co-occurence violation. Cannot have @value and child elements</assert>
