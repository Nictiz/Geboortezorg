...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title> Schematron file for POCD_MT000040NL - Jonge zwangerschapsecho (JZE) </title>
   ...
   <!-- Include the project schematrons related to scenario jze-1c -->

   <!-- cda-jze -->
   <include href="include/2.16.840.1.113883.2.4.6.10.90.1-2012-03-11T000000.sch"/>
   <include href="include/2.16.840.1.113883.2.4.6.10.90.1-2012-03-11T000000-closed.sch"/>
