...
-->
<xsl:stylesheet exclude-result-prefixes="xs xsl" xmlns="urn:hl7-org:v3" xmlns:hl7="urn:hl7-org:v3" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:template name="Kernset23">
        ...
        <subject2 typeCode="SUBJ" contextConductionInd="false">
            <CareProvisionEvent classCode="PCPR" moodCode="EVN">
                ...
                <!-- MdG: Uniek dossiernummer. Root is generieke root+lvrid, binnen lvrid moet identificatie_van_de_zwangerschap uniek zijn. Ditch leading zeros in LVR ID. -->
                <id root="2.16.840.1.113883.2.4.3.46.10.5.1.{number($param_zorgverlenerzorginstelling/zorginstelling/zorginstelling_lvrid/@value)}" extension="{$param_zwangerschap/identificatie_van_de_zwangerschap/@value}"/>
                <effectiveTime>
